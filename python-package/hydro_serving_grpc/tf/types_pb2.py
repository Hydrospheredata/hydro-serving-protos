...
_DATATYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DT_MAP_REF', index=48, number=127,
      options=None,
      type=None),
  ],
