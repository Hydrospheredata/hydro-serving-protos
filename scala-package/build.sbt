...
Global / pgpKeyRing := Some(file("/tmp/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("/tmp/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("/tmp/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("/tmp/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("/tmp/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("/tmp/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("/home/runner/.gnupg/secring.gpg"))
Global / pgpKeyRing := Some(file("/home/runner/.gnupg/secring.gpg"))
Global / pgpKeyRing := Some(file("/home/runner/.gnupg/secring.gpg"))
Global / pgpKeyRing := Some(file("/home/runner/.gnupg/secring.gpg"))
Global / pgpKeyRing := Some(file("~/secret/robot.gpg"))
...
Global / pgpKeyRing := Some(file("~/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("~/secret/robot.gpg"))
Global / pgpKeyRing := Some(file("/home/runner/.gnupg/robot.gpg"))
